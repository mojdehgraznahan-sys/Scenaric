...
function StoreProvider({ children }) {
  ...
  const [projects, setProjects] = usePersistentState("fm.projects", seed.projects);
  const [activeProjectId, setActiveProjectId] = usePersistentState("fm.activeProjectId", (seed.projects[0] && seed.projects[0].id) || null);
