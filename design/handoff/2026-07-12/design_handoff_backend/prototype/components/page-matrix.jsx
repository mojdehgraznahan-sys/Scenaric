    ...
    <div style={{ flex: 1, overflowY: "auto", padding: 20 }} className="scroll-y">
      <div className="card" style={{ padding: 18 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
          <div>
            <h2 style={{ margin: 0, fontSize: 18, fontWeight: 600, letterSpacing: "-0.01em" }}>Impact × Uncertainty Matrix</h2>
            <div style={{ color: "#6B7280", fontSize: 13, marginTop: 2 }}>Rank all your signals by impact and uncertainty. The top-right quadrant becomes the source for your scenario axes.</div>
          </div>
