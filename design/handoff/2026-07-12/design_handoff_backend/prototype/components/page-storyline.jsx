...
function PageStoryline({ navigate }) {
  ...
  return (
    <div data-screen-label="App · storyline" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", padding: 20, gap: 0 }} className="scroll-y">
      <div className="card" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", padding: 0, borderRadius: 14 }}>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden", minHeight: 0, borderRadius: "0 0 14px 14px" }}>
        <div style={{ flex: 1, overflow: "auto", background: "#F5F5F5", padding: "24px 0", borderRadius: "0 0 0 14px" }} className="scroll-y">
          <StorylineCanvas
            data={data}
