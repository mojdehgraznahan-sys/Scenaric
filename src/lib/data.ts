...
// Ported verbatim from the Claude Design handoff (data.js / window.FM_DATA).

import type { ScenaricData } from "./types";

export const FM_DATA: ScenaricData = {
  project: {
  ...
  signals: [
    { id: "sg1", category: "Political", source: "Reuters", title: "EU Carbon Border Adjustment Mechanism", impact: 5, uncertainty: "High", body: "New tariffs on carbon-intensive imports will reshape competitive dynamics across SEA supply chains by 2027.", createdAt: "2026-06-01T09:00:00.000Z" },
    { id: "sg2", category: "Technology", source: "Gartner", title: "Gen AI enterprise adoption accelerates", impact: 5, uncertainty: "Medium", body: "Enterprise AI deployment doubled YoY; productivity gains captured unevenly across sectors and geographies.", createdAt: "2026-06-03T09:00:00.000Z" },
    { id: "sg3", category: "Social", source: "Deloitte", title: "Gen Z workforce expectations shift", impact: 4, uncertainty: "Medium", body: "Workers under 30 prioritise purpose over compensation; talent wars intensifying in tech hubs.", createdAt: "2026-06-05T09:00:00.000Z" },
    { id: "sg4", category: "Political", source: "FT", title: "US-China decoupling deepens", impact: 5, uncertainty: "High", body: "Bifurcated technology stacks force multinationals to choose sides on cloud, semiconductors, and standards.", createdAt: "2026-06-07T09:00:00.000Z" },
    { id: "sg5", category: "Economic", source: "World Bank", title: "SEA middle-class doubles by 2030", impact: 4, uncertainty: "Low", body: "Rising disposable income across Indonesia, Vietnam, Philippines fuels premium consumer categories.", createdAt: "2026-06-09T09:00:00.000Z" },
    { id: "sg6", category: "Ecological", source: "IPCC", title: "Climate adaptation costs surge", impact: 4, uncertainty: "High", body: "Physical risk premiums for coastal SEA operations rising; ESG reporting mandates tighten.", createdAt: "2026-06-11T09:00:00.000Z" },
    { id: "sg7", category: "Technology", source: "IDC", title: "Mobile-first commerce dominates", impact: 3, uncertainty: "Low", body: "Over 70% of SEA digital commerce flows through super-apps; web channels secondary.", createdAt: "2026-06-13T09:00:00.000Z" },
    { id: "sg8", category: "Political", source: "Nikkei", title: "ASEAN trade harmonisation stalls", impact: 4, uncertainty: "High", body: "Regional trade agreement implementation patchy; bilateral arrangements proliferate.", createdAt: "2026-06-15T09:00:00.000Z" },
    { id: "sg9", category: "Economic", source: "Bloomberg", title: "Currency volatility regime", impact: 4, uncertainty: "High", body: "FX swings of 10-15% reshape unit economics for cross-border operations.", createdAt: "2026-06-17T09:00:00.000Z" },
  ],
  scenarios: [
    {
      id: "sc1",
      ...
      summary:
        "ASEAN consolidates as a unified trade bloc; multilateral institutions hold; AI productivity is broadly captured. Our expansion runs ahead of plan.",
      narrative:
        "By 2030, ASEAN has matured into a functional trade bloc. Customs harmonisation cleared in 2027 and digital service tariffs were eliminated by mid-decade. US-China relations stabilised after a 2026 climbdown, allowing dual-track operations to consolidate onto shared infrastructure. AI productivity gains were widely diffused: SEA-based enterprises saw 2-4% annual TFP growth from 2027 onward. For us, this is the high road. Single regional HQ in Singapore, distributed engineering across Ho Chi Minh and Jakarta, premium consumer expansion in Bangkok. Growth runs 30% ahead of plan; margins improve 600bps.",
    },
    {
      id: "sc2",
      name: "Fragmented Frontier",
      quadrant: "BR",
      color: "#F97316",
      tagline: "Open markets + misaligned politics",
      summary:
        "Markets stay open but politics fragment. Multiple AI stacks, multiple compliance regimes. Speed and modularity beat scale.",
      narrative:
    ...
    },
    {
      ...
      summary:
        "Geopolitical détente but rising protectionism. Local-for-local becomes mandatory. We trade scale for compliance.",
      narrative:
        "A surprising US-China climbdown in 2027 brings geopolitical calm — but the post-COVID instinct to onshore everything hardens into permanent industrial policy. SEA governments mandate local data, local IP, local employment. We restructure into autonomous country businesses with joint-venture partners. ROIC compresses but we hold share. The plan becomes operationally complex but politically resilient.",
    },
    {
      id: "sc4",
      name: "Bamboo Curtain",
