...
export const FOCAL_INTERVIEW_BLOCKS: BlockCopy[] = [
  {
    ...
    questions: [
      { id: "keepsAwake", label: "What keeps you awake at night?" },
      { id: "decision5to10yr", label: "What decision are you facing that will still matter in 5-10 years?" },
      { id: "ownerAndDeadline", label: "Who actually makes that decision, and by when?" },
      { id: "ifWrongBreaks", label: "If you get this wrong, what breaks?" },
    ],
  ...
  },
  {
    ...
    questions: [
      { id: "oracleQ1", label: "Question 1" },
      { id: "oracleQ2", label: "Question 2", optional: true },
      { id: "oracleQ3", label: "Question 3", optional: true },
    ],
    continueLabel: "Continue",
  },
  {
  ...
  },
  {
    ...
    questions: [
      { id: "inevitable", label: "What's effectively inevitable over that horizon?" },
